...
LANGUAGE_CODE = 'ru-ru'  # Переключим на русский для удобства в Django Admin

TIME_ZONE = 'Europe/Berlin'  # Локальное время для Германии (актуально для бронирования)
...
# 2. Настройки Django REST Framework и JWT-аутентификации
REST_FRAMEWORK = {
